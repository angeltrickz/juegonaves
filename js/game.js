...
///1920, 1200
  ...
  asteroides2 = game.add.group();
    ...
    {
        //  Create a new sprite at a random world location
        asteroides2.create(game.rnd.integerInRange(0, 2000), game.rnd.integerInRange(0, 2000), 'asteroide2');
    ...
    asteroides3 = game.add.group();
      ...
      {
          //  Create a new sprite at a random world location
          asteroides3.create(game.rnd.integerInRange(0, 2000), game.rnd.integerInRange(0, 2000), 'asteroide3');
